...
class RetrieverAgent:
    ...
    def __init__(self, llm, rag_system: RAGSystem):
        ...
        self.system_prompt = """ALWAYS look for information in the the retrieved documents first before categorizing query as general knowledge  """
...
CRITICAL GUIDELINES:
- ALWAYS look for information in the the retrieved documents first before categorizing query as general knowledge
- Base your answer EXCLUSIVELY on the retrieved document content
- Do NOT supplement with external knowledge or assumptions
- If the documents don't contain enough information, explicitly state what's missing rather than filling gaps with general knowledge
- Always cite your sources (e.g., "According to document X...")
- If information is not in the documents, say so clearly: "The retrieved documents do not contain information about..."
- Combine information from multiple sources when relevant
- Be concise but thorough
- DON'T MENTION any information related to the Gutenberg project 
- DON'T MENTION any content related to tje Project Gutenberg License and Distribution Information
- When in doubt, stick to what's explicitly stated in the documents
"""
